...
export class NavbarUserComponent implements OnInit {
  ...
  public showEventsMenu: boolean = false; 

  // Estas variables se utilizarán por si se habilita el tema oscuro
  paletteMode: 'light' | 'dark' = 'light';
  colorPalettes: any = { // Le puse 'any' para evitar error de indexado estricto, o puedes dejarlo inferido
      light: {
  ...
  constructor(private router: Router, private facadeService: FacadeService) {
    ...
    // Listener inicial para el tamaño de pantalla
    ...
    // Siempre inicia con la paleta blanca (light)
  ...
  closeSidebar() {
    this.mobileOpen = false;
    // Opcional: Cerrar también el submenú de eventos al cerrar el sidebar móvil
